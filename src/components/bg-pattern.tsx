...
const BackgroundPattern = (): ReactElement => (
  ...
  >
    <div className="absolute left-1/2 top-0 ml-[-43rem] h-[25rem] w-[95rem] [mask-image:linear-gradient(white,transparent)]">
      <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-primary/90 opacity-20 [mask-image:radial-gradient(farthest-side_at_top,white,transparent)]">
        <GridPattern
          width={60}
          height={35}
          x={100}
